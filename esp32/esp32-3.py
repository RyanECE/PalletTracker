...
MQTT_PORT = 1883
MQTT_TOPIC = "capteur/BM"
MQTT_CLIENT_ID = "ESP32-BM"
...
def send_mqtt_data(client, topic):
    distance = round(random.uniform(0, 28.28), 2)  # Génère un nombre aléatoire entre 0 et 40.78, arrondi à deux décimales
